...
app.post('/send',function(req,res){
    ...
    database.add(req.body.user,req.body.status,req.body.request1,req.body.request2,req.body.request3,req.body.tag,req.body.file1,req.body.file2,req.body.file3,req.body.file4,req.body.file5,req.body.description,
...
app.post('/push',function(req,res){
    database.push(req.body.into,req.body.pic,req.body.name,req.body.message,function(data){
        res.send(data);
    })
})
